...
-- CreateEnum
CREATE TYPE "LogAction" AS ENUM ('REGISTRATION', 'LOGIN', 'LOGOUT', 'REQUEST_CREATED');
...
-- DropForeignKey
ALTER TABLE "request" DROP CONSTRAINT "request_role_id_fkey";

-- DropForeignKey
ALTER TABLE "role" DROP CONSTRAINT "role_access_id_fkey";
...
-- DropForeignKey
ALTER TABLE "user_request" DROP CONSTRAINT "user_request_request_id_fkey";
